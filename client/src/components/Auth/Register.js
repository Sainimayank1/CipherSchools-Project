            ...
            <div className={style.login_sub}>
                ...
                <div className={style.down}>
                    ...
                    <div className={style.form}>
                        <input type='text' placeholder='First name' name='fname' onChange={handleChange}></input>
                        <input type='text' placeholder='Last name' name='lname' onChange={handleChange}></input>
                    ...
                    <div className={style.btn2} onClick={handleSubmit}>
                        Signin
                    </div>
                    <div className={style.register}>
                        <h3>Already have an account ? <Link to={'/login'}>Signin Now</Link></h3>
                    </div>
                </div>
            </div>
        </div>
